...
const POLICIES_DATA = [
    { id: 'POL-2026-1001', customer: 'Jeraldine Paez Tomasini', location: 'College Park, MD',
      ...
      clientId: 'CLI-001', stage: 'Quoting', aptc: '$332 est.', plan: '' },
    { id: 'POL-2026-1002', customer: 'Carlos Mendoza', location: 'Miami, FL',
      ...
      clientId: 'CLI-002', stage: 'Active', aptc: '$0.00', plan: 'Aetna MAPD PPO' },
    { id: 'POL-2026-1003', customer: 'Ana Lucia Fernandez', location: 'Houston, TX',
      ...
      clientId: 'CLI-003', stage: 'Documents', aptc: '$280.00', plan: 'Ambetter Silver 5' },
    { id: 'POL-2026-1004', customer: 'Roberto Silva', location: 'Austin, TX',
      ...
      clientId: 'CLI-004', stage: 'Enrollment', aptc: '$0.00', plan: 'Cigna Term Life 500k' },
...
const CLIENTS_DATA = [
    { id: 'CLI-001', name: 'Jeraldine Paez Tomasini', firstName: 'Jeraldine', lastName: 'Paez Tomasini',
      phone: '(786) 782-3051', email: 'jpaezt135@gmail.com', city: 'College Park', state: 'MD',
      zip: '20740', county: "Prince George's", language: 'Spanish', maritalStatus: 'Single',
      dob: '08-12-1995', ssn: '•••-••-8724', immigration: 'Employment Authorization', smoker: 'No',
      gender: 'Female', countryOfBirth: 'Venezuela', income: '$24,000', householdSize: 1, fpl: '160%',
      applicants: 1, agent: 'Ivan Diaz', since: 'May 2026',
      household: [
        { name: 'Jeraldine Paez', relation: 'Principal', dob: '1995', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-8724', immigration: 'Employment Authorization' },
      ] },
    { id: 'CLI-002', name: 'Carlos Mendoza', firstName: 'Carlos', lastName: 'Mendoza',
      phone: '(305) 555-1234', email: 'cmendoza@email.com', city: 'Miami', state: 'FL',
      zip: '33126', county: 'Miami-Dade', language: 'Spanish', maritalStatus: 'Married',
      dob: '03-15-1958', ssn: '•••-••-6789', immigration: 'Citizen', smoker: 'No',
      gender: 'Male', countryOfBirth: 'Cuba', income: '$0', householdSize: 2, fpl: 'Medicare',
      applicants: 2, agent: 'Nacho Molano', since: 'Dec 2025',
      household: [
        { name: 'Carlos Mendoza', relation: 'Principal', dob: '1958', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-6789', immigration: 'Citizen' },
        { name: 'Rosa Mendoza', relation: 'Cónyuge', dob: '1960', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-2233', immigration: 'Citizen' },
      ] },
    { id: 'CLI-003', name: 'Ana Lucia Fernandez', firstName: 'Ana Lucia', lastName: 'Fernandez Rojas',
      phone: '(713) 555-9876', email: 'analucia@email.com', city: 'Houston', state: 'TX',
      zip: '77063', county: 'Harris', language: 'Spanish', maritalStatus: 'Married',
      dob: '07-22-1990', ssn: '•••-••-4321', immigration: 'Permanent Resident', smoker: 'No',
      gender: 'Female', countryOfBirth: 'Colombia', income: '$48,000', householdSize: 3, fpl: '192%',
      applicants: 3, agent: 'Nacho Molano', since: 'Mar 2026',
      household: [
        { name: 'Ana Lucia Fernandez', relation: 'Principal', dob: '1990', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-4321', immigration: 'Permanent Resident' },
        { name: 'Diego Fernandez', relation: 'Cónyuge', dob: '1988', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-7788', immigration: 'Permanent Resident' },
        { name: 'Mariana Fernandez', relation: 'Dependiente', dob: '2018', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-9900', immigration: 'Citizen' },
      ] },
    { id: 'CLI-004', name: 'Roberto Silva', firstName: 'Roberto', lastName: 'Silva',
      phone: '(512) 555-7654', email: 'rsilva@email.com', city: 'Austin', state: 'TX',
      zip: '78701', county: 'Travis', language: 'English', maritalStatus: 'Married',
      dob: '11-30-1975', ssn: '•••-••-9012', immigration: 'Citizen', smoker: 'No',
      gender: 'Male', countryOfBirth: 'Brazil', income: '$75,000', householdSize: 3, fpl: '300%',
      applicants: 3, agent: 'Nacho Molano', since: 'Jan 2026',
      household: [
        { name: 'Roberto Silva', relation: 'Principal', dob: '1975', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-9012', immigration: 'Citizen' },
        { name: 'Paula Silva', relation: 'Cónyuge', dob: '1978', taxHousehold: true, seeksCoverage: false, smoker: 'No', ssn: '•••-••-1122', immigration: 'Citizen' },
        { name: 'Lucas Silva', relation: 'Dependiente', dob: '2012', taxHousehold: true, seeksCoverage: true, smoker: 'No', ssn: '•••-••-3344', immigration: 'Citizen' },
      ] },
    { id: 'CLI-005', name: 'Maria Gonzalez', firstName: 'Maria', lastName: 'Gonzalez Lopez',
      phone: '(407) 555-3210', email: 'mgonzalez@email.com', city: 'Orlando', state: 'FL',
      zip: '32819', county: 'Orange', language: 'Spanish', maritalStatus: 'Divorced',
      dob: '05-10-1985', ssn: '•••-••-9876', immigration: 'Permanent Resident', smoker: 'No',
      gender: 'Female', countryOfBirth: 'Mexico', income: '$42,000', householdSize: 1, fpl: '280%',
      applicants: 1, agent: 'Ivan Diaz', since: 'Feb 2026',
      household: [
